...
#if KERNEL_TIME_SLICE < 1 || KERNEL_TIME_SLICE > 16
#   error unsupported KERNEL_TIME_SLICE for timer 0/2, \
    KERNEL_TIME_SLICE must be in range 1 to 16 (ms)
#endif
#elif KERNEL_SYSLOCK_HW_TIMER == 0
#if KERNEL_TIME_SLICE < 1 || (KERNEL_TIME_SLICE > 16 && (
    KERNEL_TIME_SLICE != 20 &&
    KERNEL_TIME_SLICE != 25 &&
    KERNEL_TIME_SLICE != 50 &&
    KERNEL_TIME_SLICE != 100 &&
    KERNEL_TIME_SLICE != 200 &&
    KERNEL_TIME_SLICE != 250 &&
    KERNEL_TIME_SLICE != 500 &&
    KERNEL_TIME_SLICE != 1000 &&
    KERNEL_TIME_SLICE != 2000 &&
    KERNEL_TIME_SLICE != 2500 &&
    KERNEL_TIME_SLICE != 3000 &&
    KERNEL_TIME_SLICE != 4000 &&
)) 
#   error unsupported KERNEL_TIME_SLICE for timer 1, \
    KERNEL_TIME_SLICE must be in [1; 16] U \
