...
#define KERNEL_SYSCLOCK_TIMER0_TCNT0 16
#elif KERNEL_TIME_SLICE == 2
#define KERNEL_SYSCLOCK_TIMER0_TCNT0 31
#elif KERNEL_TIME_SLICE == 3
#define KERNEL_SYSCLOCK_TIMER0_TCNT0 47
#elif KERNEL_TIME_SLICE == 4
#define KERNEL_SYSCLOCK_TIMER0_TCNT0 62
