...
#if defined(CONFIG_MAIN_STARTUP_INTERRUPT_POLICY)
#	define MAIN_STARTUP_INTERRUPT_POLICY CONFIG_MAIN_STARTUP_INTERRUPT_POLICY
#else
#	define MAIN_STARTUP_INTERRUPT_POLICY DEFAULT_MAIN_STARTUP_INTERRUPT_POLICY
#endif /* CONFIG_MAIN_STARTUP_INTERRUPT_POLICY */
