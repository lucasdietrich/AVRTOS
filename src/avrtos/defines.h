...
// preemptive threads
#if defined(CONFIG_KERNEL_COOPERATIVE_THREADS)
#   define KERNEL_COOPERATIVE_THREADS CONFIG_KERNEL_COOPERATIVE_THREADS
#else
#   define KERNEL_COOPERATIVE_THREADS DEFAULT_KERNEL_COOPERATIVE_THREADS
#endif
...
#endif /* KERNEL_COOPERATIVE_THREADS */
...
#if defined(CONFIG_KERNEL_ARGS_CHECKS)
#	define KERNEL_ARGS_CHECKS CONFIG_KERNEL_ARGS_CHECKS
#else
#	define KERNEL_ARGS_CHECKS DEFAULT_KERNEL_ARGS_CHECKS
