...
K_THREAD_DEFINE(led, thread_led_toggle, 0x100, K_PRIO_PREEMPT(K_PRIO_HIGH), NULL, 'L');
K_THREAD_DEFINE(task1, thread_processing, 0x100, K_PRIO_PREEMPT(K_PRIO_HIGH), NULL, 'A');
K_THREAD_DEFINE(task2, thread_processing, 0x100, K_PRIO_PREEMPT(K_PRIO_HIGH), NULL, 'B');
